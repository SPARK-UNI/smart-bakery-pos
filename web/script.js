    ...
    return new Promise((resolve)=>{
      ...
      img.onload=()=>{
        ...
        if (layout==='auto6'){
          ...
          boxes=[
            { x: 0.254*W, y: 0.095*H, w: 0.187*W, h: 0.306*H },
            { x: 0.456*W, y: 0.081*H, w: 0.189*W, h: 0.316*H },
            { x: 0.653*W, y: 0.075*H, w: 0.188*W, h: 0.342*H },
            { x: 0.253*W, y: 0.421*H, w: 0.236*W, h: 0.488*H },
            { x: 0.561*W, y: 0.435*H, w: 0.28*W, h: 0.457*H }
          ];
        }else if (layout==='manual5flip'){
          boxes=[
            // { x: 0.059*W, y: 0.06*H, w: 0.341*W, h: 0.525*H },
            // { x: 0.498*W, y: 0.06*H, w: 0.427*W, h: 0.525*H },         
            // { x: 0.07*W, y: 0.417*H, w: 0.27*W, h: 0.35*H },
            // { x: 0.355*W, y: 0.417*H, w: 0.27*W, h: 0.35*H },
            // { x: 0.63*W, y: 0.417*H, w: 0.27*W, h: 0.35*H }

            { x: 0.073*W, y: 0.088*H, w: 0.401*W, h: 0.472*H },
            { x: 0.57*W, y: 0.075*H, w: 0.306*W, h: 0.481*H },
            { x: 0.075*W, y: 0.571*H, w: 0.261*W, h: 0.329*H },
            { x: 0.341*W, y: 0.571*H, w: 0.268*W, h: 0.329*H },
            { x: 0.612*W, y: 0.571*H, w: 0.272*W, h: 0.338*H }

          ];
        }else if (layout==='manual3'){
          boxes=[
            { x: 0.052*W, y: 0.057*H, w: 0.88*W, h: 0.387*H },
            { x: 0.065*W, y: 0.458*H, w: 0.371*W, h: 0.518*H },
            { x: 0.524*W, y: 0.45*H, w: 0.421*W, h: 0.498*H }
          ];
        }
